...
import getErrorMessage from 'src/@core/utils/firebase-error'
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.error(getErrorMessage(result.message) || 'Bir hata oluştu. Lütfen tekrar deneyin.1', {
          position: 'bottom-center'
        })
      }
    } catch (error) {
      ...
      toast.error('Bir hata oluştu. Lütfen tekrar deneyin.2', {
        position: 'bottom-center'
      })
    }
  }
